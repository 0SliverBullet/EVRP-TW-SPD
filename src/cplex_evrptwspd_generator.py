    ...
    with open(file_path, 'r') as file:
        ...
        for line in lines[1:]:
            ...
            if parts[0] == 'Q':
                ...
                for _ in range(3):  
                # we set three copies as dummy vertex for each charging station in .dat files
...
if __name__ == "__main__":
    paths=["./data/evrptwspd_instances/small_instances/Cplex5er",
           "./data/evrptwspd_instances/small_instances/Cplex10er",
           "./data/evrptwspd_instances/small_instances/Cplex15er",
           "./data/evrptwspd_instances/large_instances"]
    for filePath in paths:
            fcases=os.listdir(filePath) 
            for pcase in fcases:  
                 input_file = filePath+"/"+pcase
                 output_file = filePath.replace("data/evrptwspd_instances", "src/cplex_evrptwspd")+"/"+pcase.replace("txt","dat")
