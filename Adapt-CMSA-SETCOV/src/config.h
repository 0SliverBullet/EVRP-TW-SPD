...
const double DEFAULT_T_PROP = 0.23; // [0.1, 0.8]
const double DEFAULT_T_ILP = 20; // {5, 7, 10, 15, 20, 25, 30, 35, 40}
const double DEFAULT_ALPHA_LB = 0.75; // [0.6, 0.99]
const double DEFAULT_ALPHA_UB = 0.86; // [0.6, 0.99]
...
const int DEFAULT_N_A = 10; // {1, 3, 5, 10, 50, 100, 200, 300, 500}
const int DEFAULT_L_SIZE = 10; // {3, 5, 10, 15, 20, 50, 100, 200}
// const double DEFAULT_GAMMA = 0.1; // not use
const int DEFAULT_DELTA_N = 50; // {1, 3, 5, 10, 50, 100, 200, 300, 400} 
const int DEFAULT_DELTA_L_SIZE = 20; // {3, 5, 10, 15, 20, 50, 100, 200}
...
const double  DEFAULT_LAMBDA = 1.38;
const double  DEFAULT_MU = 0.58;
